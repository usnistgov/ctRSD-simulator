...
for n in range(len(IN1)):
    ...
    plt.plot(model.sol.t/60,(1-REP/model.REP_con[1])*100,color=csl[n],linewidth=1.5,linestyle=':')
    # plt.subplot(3,5,7)
    # plt.plot(model.sol.t/60,1-REP/model.REP_con[1],color=csl[n],linewidth=1.5,linestyle=':')
