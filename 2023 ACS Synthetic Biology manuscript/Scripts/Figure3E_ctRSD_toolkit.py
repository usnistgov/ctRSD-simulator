# -*- coding: utf-8 -*-
"""
Created on Wed Jul 27 16:29:37 2022
...
plt.figure(1)
plt.subplot(3,5,1)
plt.plot(t-ts,DDn[:,16]*100,color=clp,linewidth=2)
plt.plot(t-ts,DDn[:,0]*100,color=clp2[0],linewidth=2)
...
for n in range(15):
    plt.subplot(3,5,n+1)
    plt.plot(t-ts,DDn[:,n+1]*100,color=clp2[n+1],linewidth=2)
    plt.plot(t-ts,DDn[:,n+1+16]*100,color=clp,linewidth=2)
    plt.xticks(fontsize=fs)
    plt.yticks(fontsize=fs)
    plt.ylim(-10,110)
    plt.xlim(0,180)
...
plt.subplot(3,5,1)
for n in range(16):
    plt.plot(t-ts,DDn[:,n+16]*100,color=clp2[n],linewidth=2,alpha=0.25)
