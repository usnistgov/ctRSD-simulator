# -*- coding: utf-8 -*-
"""
Created on Wed Jul 27 16:34:07 2022
...
ws = wb.sheet_by_name('Figure 4D, bottom')
...
# fluorescence plots
plt.figure(1)
for n in range(int(len(DDn[1,:])/2)):
    plt.subplot(3,5,1)
    plt.plot(t-ts,DDn[:,n+1]*100,color=clp2[n],alpha=0.25,linewidth=2)
    plt.plot(t-ts,DDn[:,n+4+1]*100,color=clp2[n],linewidth=2)
