# -*- coding: utf-8 -*-
"""
Created on Thu Jul 28 10:22:01 2022
...
ws = wb.sheet_by_name('Figure S14C')
...
plt.subplot(3,5,1)
plt.plot(t-ts,DDn[:,1]*100,color=clp[0],alpha=0.25,linewidth=2)
plt.plot(t-ts,DDn[:,2]*100,color=clp[1],alpha=0.25,linewidth=2)
