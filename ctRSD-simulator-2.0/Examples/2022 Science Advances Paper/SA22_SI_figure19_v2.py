...
model.molecular_species('R{1}',ic=REP_con)
...
for n in range(len(X)):
    ...
    model.global_rate_constants(ktxn=k_txn,krev=(270/1e9)*X[n]) #globally change transcription / reverse rates
    model.molecular_species('G{1,2}',DNA_con=25,krev=(5/1e9)*X[n]) #update correspodning reverse rate
...
# initialize species involved in the reaction
model.molecular_species('G{4,3}',DNA_con=25)
model.molecular_species('G{3,1}',DNA_con=25)
...
for n in range(len(X)):
    ...
    model.global_rate_constants(ktxn=k_txn,krev=(270/1e9)*X[n]) #globally change transcription / reverse rates
    model.molecular_species('G{1,2}',DNA_con=25,krev=(5/1e9)*X[n]) #update corresponding reverse rate
...
# initialize species involved in the reaction
model.molecular_species('G{5,4}',DNA_con=25)
model.molecular_species('G{4,3}',DNA_con=25)
model.molecular_species('G{3,1}',DNA_con=25)
model.molecular_species('R{2}',ic=REP_con)
...
for n in range(len(X)):
    ...
    model.global_rate_constants(ktxn=k_txn,krev=(270/1e9)*X[n]) #globally change transcription / reverse rates
    model.molecular_species('G{1,2}',DNA_con=25,krev=(5/1e9)*X[n])    
