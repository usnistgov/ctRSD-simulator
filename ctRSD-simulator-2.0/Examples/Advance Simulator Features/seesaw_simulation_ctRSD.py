...
model1.molecular_species('G{1,2}',DNA_con=16)
model1.molecular_species('G{3,2}',DNA_con=16)
model1.molecular_species('G{2,4}',DNA_con=25)
model1.molecular_species('R{4}',ic=REP_con)
model1.molecular_species('TG{2}',DNA_con=30)
