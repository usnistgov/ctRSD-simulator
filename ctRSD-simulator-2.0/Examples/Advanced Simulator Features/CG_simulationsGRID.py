...
#model1.global_rate_constants(krsdCG=5e5/1e9) # to increase the forward rates with CG
...
for i in range(len(IN_temp1)):
    for j in range(len(IN_temp2)):
        ...
        model1.molecular_species('I{6}',DNA_con=IN_temp1[i])
        model1.molecular_species('I{7}',DNA_con=IN_temp2[j])
