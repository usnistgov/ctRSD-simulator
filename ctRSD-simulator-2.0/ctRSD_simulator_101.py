...
VERSION 1.0.1
Updated a erroneous duplicate term in the WTA (CG) reactions
This version also has the same reverse strand displacement rate constant for all domains 
    1.0.0 had a lower rate constant value for 2 domains.
